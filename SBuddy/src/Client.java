...
public class Client implements Runnable {
	...
	/**
	 * Construct the class by passing on arguments for the IP and the port of
	 * the server
	 * 
	 * @param args
	 */
	...
	public void run() {
		try {
			...
			System.out.println("Connected to " + requestSocket.getInetAddress() + " on port " + requestSocket.getPort()
					+ " from port " + requestSocket.getLocalPort() + " of " + requestSocket.getLocalAddress());
